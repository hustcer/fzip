...
**最近更新**: 2026-03-08 - 新增 8 个测试，覆盖率从 96.57% 提升到 96.97%

## 📁 各文件覆盖率详情

| 文件        | 未覆盖行数 | 优先级 | 说明                             |
| ----------- | ---------- | ------ | -------------------------------- |
| zip.mbt     | 26         | 🔴 高  | ZIP 格式处理，最多未覆盖代码     |
| deflate.mbt | 22         | 🟡 中  | 核心压缩算法，部分边界情况未覆盖 |
| inflate.mbt | 17         | 🟡 中  | 核心解压算法，部分错误路径未覆盖 |
| huffman.mbt | 14         | 🟡 中  | Huffman 编码，部分边界情况       |
| stream.mbt  | 13         | 🟢 低  | 流式 API，已补充基本测试 ✅      |
| gzip.mbt    | 11         | 🟢 低  | GZIP 格式，覆盖较好              |
